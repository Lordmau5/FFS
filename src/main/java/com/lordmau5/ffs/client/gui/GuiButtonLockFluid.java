...
class GuiButtonLockFluid extends GuiButton {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY) {
		if(this.visible) {
			...
			this.drawTexturedModalRect(this.xPosition - 1, this.yPosition, 48, 128, 8, 8);
			this.drawTexturedModalRect(this.xPosition, this.yPosition - 1, getState() ? 1 : 9, 128, this.width, this.height);
