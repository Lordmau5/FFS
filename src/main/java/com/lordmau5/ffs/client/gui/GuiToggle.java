...
class GuiToggle extends GuiButton {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY) {
		if(this.visible) {
			...
			this.drawTexturedModalRect(this.xPosition, this.yPosition, getState() ? 32 : 16, 128, this.width, this.height);
			this.mouseDragged(mc, mouseX, mouseY);

			fontrenderer.drawString(this.displayString, this.xPosition, this.yPosition + 10, this.textColor);
		}
	}
