...
public class GuiValve extends GuiScreen {
	...
	private void initGuiValve() {
		...
		if(this.tile instanceof INameableTile) {
			this.tileName = new GuiTextField(0, this.fontRendererObj, this.left + 90, this.top + 102, 82, 10);
	...
	private void drawGUIValve(int x, int y, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj, fluid, this.left + (this.xSize_Valve / 2), this.top + 6, 16777215);
	...
	private void drawGUINoValve(int x, int y, float partialTicks) {
		...
		this.drawCenteredString(this.fontRendererObj, fluid, this.left + (this.xSize_NoValve / 2), this.top + 6, 16777215);
	...
	private void drawTileName(int x, int y) {
		int length = this.fontRendererObj.getStringWidth("Tile Name");
		this.fontRendererObj.drawString(ChatFormatting.BLACK + "Tile Name", x + 86 + (length / 2), y + 90, Color.white.getRGB());
	...
	private void lockedFluidHoveringText() {
		...
		drawHoveringText(texts, this.mouseX, this.mouseY, this.fontRendererObj);
